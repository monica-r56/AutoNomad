      ...
      <div className="relative bg-background pb-16">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {[
              { name: "Switzerland", slug: "switzerland", img: "/images/destination-switzerland.jpg", tag: "Alpine Beauty" },
              { name: "Sweden", slug: "sweden", img: "/images/destination-sweden.jpg", tag: "Nordic Charm" },
              { name: "London", slug: "london", img: "/images/destination-london.jpg", tag: "Historic Elegance" },
            ].map((dest) => (
              <Link
                key={dest.name}
