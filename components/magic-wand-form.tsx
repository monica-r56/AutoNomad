...
import { GenerateTripButton } from "@/components/generate-trip-button";
...
export function MagicWandForm() {
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    sessionStorage.setItem(
      ...
      JSON.stringify({
        ...form,
        origin: form.originLocation?.displayName || form.origin,
        destination: form.destinationLocation?.displayName || form.destination,
      })
    );
